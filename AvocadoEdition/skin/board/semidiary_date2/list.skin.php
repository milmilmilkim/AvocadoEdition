...
<!-- 게시판 카테고리 시작 { -->
	...
	<? } else { ?>
		<a href="<?php echo $write_href ?>" class="ui-btn">업로드</a>
	<? } } ?>
		<a href="<?php echo $list_href ?>" class="ui-btn">F5</a>
		<a href="<?php echo $board_skin_url ?>/emoticon/" class="ui-btn etc new_win">이모티콘</a>
		<?if($is_admin){?>
		<a href="<?php echo G5_ADMIN_URL ?>/board_form.php?bo_table=<?=$bo_table?>&w=u" class="ui-btn point">관리자</a><?}?>
	</div>
